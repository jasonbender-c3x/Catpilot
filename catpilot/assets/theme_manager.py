...
class ThemeManager:
  def __init__(self):
    ...
    self.session.headers.update({"User-Agent": "catpilot-theme-downloader/1.0 (https://github.com/CatAi/CatPilot)"})
  ...
  def update_active_theme(self, time_validated, catpilot_toggles, boot_run=False, randomize_theme=False):
    if time_validated and catpilot_toggles.holiday_themes:
    ...
    elif (boot_run or randomize_theme) and catpilot_toggles.random_themes:
    ...
    elif not catpilot_toggles.random_themes:
      asset_mappings = {
        "color_scheme": ("colors", catpilot_toggles.color_scheme),
        "distance_icons": ("distance_icons", catpilot_toggles.distance_icons),
        "icon_pack": ("icons", catpilot_toggles.icon_pack),
        "sound_pack": ("sounds", catpilot_toggles.sound_pack),
        "turn_signal_pack": ("signals", catpilot_toggles.signal_icons),
        "wheel_image": ("wheel_image", catpilot_toggles.wheel_image)
      }
    else:
      return
  ...
  def validate_themes(self, downloadable_colors, downloadable_distance_icons, downloadable_icons, downloadable_signals, downloadable_sounds, downloadable_wheels, catpilot_toggles):
    asset_mappings = {
      "CustomColors": ("colors", catpilot_toggles.color_scheme, downloadable_colors),
      "CustomDistanceIcons": ("distance_icons", catpilot_toggles.distance_icons, downloadable_distance_icons),
      "CustomIcons": ("icons", catpilot_toggles.icon_pack, downloadable_icons),
      "CustomSounds": ("sounds", catpilot_toggles.sound_pack, downloadable_sounds),
      "CustomSignals": ("signals", catpilot_toggles.signal_icons, downloadable_signals),
      "WheelIcon": ("steering_wheels", catpilot_toggles.wheel_image, downloadable_wheels)
    }
  ...
  def update_themes(self, catpilot_toggles, boot_run=False):
    ...
    if boot_run:
      self.validate_themes(downloadable_colors, downloadable_distance_icons, downloadable_icons, downloadable_signals, downloadable_sounds, downloadable_wheels, catpilot_toggles)
