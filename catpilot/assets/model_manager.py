...
TINYGRAD_MODELD_PATH = Path(BASEDIR) / "catpilot/tinygrad_modeld"
...
class ModelManager:
  def __init__(self):
    ...
    self.session.headers.update({"User-Agent": "catpilot-model-downloader/1.0 (https://github.com/CatAi/CatPilot)"})
