...
class NeuralNetworkFeedforward:
  ...
  def compute_nnff(self, CS, VM, actual_lateral_accel, desired_lateral_accel, gravity_adjusted_lateral_accel, lateral_accel_deadzone, llk, measurement, model_data, params, pid_log, roll_compensation, setpoint, catpilot_toggles):
    ...
    if self.lat_control_torque.nnff_loaded and model_good and catpilot_toggles.nnff:
      # update past data
      pitch = 0
      roll = params.roll
