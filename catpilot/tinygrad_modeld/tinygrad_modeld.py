...
def main(demo=False):
  ...
  use_curvature_from_plan = catpilot_toggles.model_version not in {"v7", "v8"}
  ...
  sm = SubMaster(["deviceState", "carState", "roadCameraState", "liveCalibration", "driverMonitoringState", "carControl", "liveDelay", "catpilotPlan"])
