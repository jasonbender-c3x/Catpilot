...
def get_drive_stats():
  ...
  stats["catpilot"] = {
    "distance": params_tracking.get_int("CatPilotKilometers") * conversion,
    "hours": params_tracking.get_int("CatPilotMinutes") / 60,
    "drives": params_tracking.get_int("CatPilotDrives"),
    "unit": unit
  }
