...
from catpilot.selfdrive.locationd.models.car_kf import CarKalman, ObservationKind, States
from catpilot.selfdrive.locationd.models.constants import GENERATED_DIR
...
def main():
  ...
  sm = messaging.SubMaster(['liveLocationKalman', 'carState', 'catpilotPlan'], poll='liveLocationKalman')
  ...
  while True:
    ...
    if sm.updated['liveLocationKalman']:
      ...
      liveParameters.steerRatio = float(x[States.STEER_RATIO].item() if not catpilot_toggles.use_custom_steerRatio else catpilot_toggles.steerRatio)
