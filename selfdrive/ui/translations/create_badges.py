...
from catpilot.selfdrive.ui.tests.test_translations import UNFINISHED_TRANSLATION_TAG
from catpilot.selfdrive.ui.update_translations import LANGUAGES_FILE, TRANSLATIONS_DIR
