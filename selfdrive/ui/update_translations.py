...
CATPILOT_UI_DIR = os.path.join(BASEDIR, "catpilot", "ui")
...
def generate_translations_include():
  # offroad alerts
  # TODO translate events from catpilot.selfdrive/controls/lib/events.py
...
def update_translations(vanish: bool = False, translation_files: None | list[str] = None, translations_dir: str = TRANSLATIONS_DIR):
  ...
  for file in translation_files:
    ...
    args = f"lupdate -locations none -recursive {UI_DIR} {CATPILOT_UI_DIR} -ts {tr_file} -I {BASEDIR}"
    if vanish:
      args += " -no-obsolete"
