...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, steer_limited, desired_curvature, llk, model_data=None, catpilot_toggles=None):
    ...
    if not active:
      ...
      low_speed_factor = interp(CS.vEgo, LOW_SPEED_X, LOW_SPEED_Y_NN if catpilot_toggles.nnff else LOW_SPEED_Y)**2
      setpoint = desired_lateral_accel + low_speed_factor * desired_curvature
      measurement = actual_lateral_accel + low_speed_factor * actual_curvature
      gravity_adjusted_lateral_accel = desired_lateral_accel - roll_compensation
      if self.nnff_loaded and catpilot_toggles.nnff or catpilot_toggles.nnff_lite:
        torque_from_setpoint, torque_from_measurement, pid_log, ff = self.nnff.compute_nnff(
          ...
          llk, measurement, model_data, params, pid_log, roll_compensation, setpoint, catpilot_toggles
        )
      else:
      ...
      self.pid._k_p = catpilot_toggles.steerKp
