...
def plannerd_thread():
  ...
  tomb_raider = catpilot_toggles.tomb_raider

  while True:
    sm.update()
    if sm.updated['modelV2']:
      longitudinal_planner.update(tomb_raider, sm, catpilot_toggles)
      longitudinal_planner.publish(classic_model, tomb_raider, sm, pm, catpilot_toggles)
