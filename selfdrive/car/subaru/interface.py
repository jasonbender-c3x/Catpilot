...
class CarInterface(CarInterfaceBase):
  ...
  @staticmethod
  def _get_params(ret, candidate: CAR, fingerprint, car_fw, experimental_long, docs, catpilot_toggles):
    ret.carName = "subaru"
  ...
  def _update(self, c, catpilot_toggles):
    ...
    ret, fp_ret = self.CS.update(self.cp, self.cp_cam, self.cp_body, catpilot_toggles)
