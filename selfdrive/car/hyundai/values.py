...
class CarControllerParams:
  ...
  def __init__(self, CP, vEgoRaw=100., catpilot_toggles=None):
    ...
    if CP.carFingerprint in CANFD_CAR and catpilot_toggles and catpilot_toggles.taco_tune_hacks:
...
class HyundaiCatPilotFlags(IntFlag):
  CAN_LFA_BTN = 1
  LKAS12 = 2
  NAV_MSG = 2 ** 2
