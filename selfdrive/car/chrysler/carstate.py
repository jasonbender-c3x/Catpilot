...
from openpilot.selfdrive.car.chrysler.values import ChryslerCatPilotFlags, DBC, STEER_THRESHOLD, RAM_CARS
...
class CarState(CarStateBase):
  def __init__(self, CP, FPCP):
    ...
    self.button_message = "CRUISE_BUTTONS_ALT" if FPCP.fpFlags & ChryslerCatPilotFlags.RAM_HD_ALT_BUTTONS else "CRUISE_BUTTONS"
  ...
  def get_can_parser(CP, FPCP):
    button_message = "CRUISE_BUTTONS_ALT" if FPCP.fpFlags & ChryslerCatPilotFlags.RAM_HD_ALT_BUTTONS else "CRUISE_BUTTONS"
    messages = [
