...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, ext_cp, trans_type, catpilot_toggles):
    if self.CP.flags & VolkswagenFlags.PQ:
      return self.update_pq(pt_cp, cam_cp, ext_cp, trans_type, catpilot_toggles)
  ...
  def update_pq(self, pt_cp, cam_cp, ext_cp, trans_type, catpilot_toggles):
    ret = car.CarState.new_message()
    fp_ret = custom.CatPilotCarState.new_message()
    # Update vehicle speed and acceleration from ABS wheel speeds.
    ret.wheelSpeeds = self.get_wheel_speeds(
