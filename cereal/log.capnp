...
struct ControlsState @0x97ff69c53601abf1 {
  ...
  enum AlertStatus {
    ...
    catpilot @3;    # CatPilot startup alert
  }
...
struct Event {
  ...
  union {
    ...
    catpilotCarParams @107 :Custom.CatPilotCarParams;
    catpilotCarState @108 :Custom.CatPilotCarState;
    catpilotDeviceState @109 :Custom.CatPilotDeviceState;
    catpilotNavigation @110 :Custom.CatPilotNavigation;
    catpilotPlan @111 :Custom.CatPilotPlan;
