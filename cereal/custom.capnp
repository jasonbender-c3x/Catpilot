...
struct CatPilotDeviceState @0xf35cc4560bbf6ec2 {
  freeSpace @0 :Int16;
  usedSpace @1 :Int16;
}

struct CatPilotNavigation @0xda96579883444c35 {
  approachingIntersection @0 :Bool;
  approachingTurn @1 :Bool;
  navigationSpeedLimit @2 :Float32;
}

struct CatPilotPlan @0x80ae746ee2596b11 {
  ...
  catpilotEvents @7 :List(Car.CarEvent);
  lateralCheck @8 :Bool;
