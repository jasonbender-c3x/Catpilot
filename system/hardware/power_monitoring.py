...
class PowerMonitoring:
  ...
  def should_shutdown(self, ignition: bool, in_car: bool, offroad_timestamp: float | None, started_seen: bool, catpilot_toggles):
    ...
    low_voltage_shutdown = (self.car_voltage_mV < (catpilot_toggles.low_voltage_shutdown * 1e3) and
                            offroad_time > VOLTAGE_SHUTDOWN_MIN_OFFROAD_TIME_S)
    should_shutdown |= offroad_time > catpilot_toggles.device_shutdown_time
