...
def manager_init() -> None:
  ...
  for k, v, stock in [(k, v, v) for k, v in default_params] + [(k, v, stock) for k, v, _, stock in catpilot_default_params]:
  ...
  catpilot_boot_functions(build_metadata, params_cache)
...
def manager_thread() -> None:
  ...
  sm = messaging.SubMaster(['deviceState', 'carParams', 'catpilotPlan'], poll='deviceState')
  pm = messaging.PubMaster(['managerState'])

  write_onroad_params(False, params)
  ensure_running(managed_processes.values(), False, params=params, CP=sm['carParams'], not_run=ignore, classic_model=False, tinygrad_model=False, catpilot_toggles=get_catpilot_toggles())
  ...
  classic_model = catpilot_toggles.classic_model
  tinygrad_model = catpilot_toggles.tinygrad_model
  ...
  while True:
    ...
    ensure_running(managed_processes.values(), started, params=params, CP=sm['carParams'], not_run=ignore, classic_model=classic_model, tinygrad_model=tinygrad_model, catpilot_toggles=catpilot_toggles)
