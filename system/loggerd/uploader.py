...
def main(exit_event: threading.Event = None) -> None:
  ...
  sm = messaging.SubMaster(['deviceState', 'catpilotPlan'])
  ...
  while not exit_event.is_set():
    ...
    at_home = offroad and network_type in (NetworkType.ethernet, NetworkType.wifi) or not catpilot_toggles.no_onroad_uploads
